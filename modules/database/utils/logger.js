...
/**
 * @fileoverview Centralized logger for the Database module.
 * Prefixes all messages with [DATABASE] and supports CALL/DONE tracing.
...
/**
 * Core logger object with info, error, warn, debug, call, and done levels.
 */
const logger = {
    /**
